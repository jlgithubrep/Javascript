...
let balance = 100;
let mise;//somme misée par l'utilisateur sur le bon chiffre
let miseColor;//somme misée par le user sur la couleur
let miseParite;//somme misée par le user la parité
let text = "";
let text2 = "";
let text3 = "";
let resultatPrecedant;
